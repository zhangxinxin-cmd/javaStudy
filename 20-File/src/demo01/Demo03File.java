...
public class Demo03File {
    ...
    private static void show04() {
        ...
        long l1 = f1.length();
        System.out.println(l1);//1479992
        File f2=new File("D:\\photo\\ccc.jpg");
        System.out.println(f2.length());
        File f3=new File("D:\\photo");
        long l3 = f3.length();
    ...
    private static void show03() {
        ...
        String name1 = f1.getName();//123.txt
        System.out.println(name1);
        File f2=new File("D:\\idealProjects\\basic-code\\20-File");
        String name2 = f2.getName();
        System.out.println(name2);//20-File
    }
    ...
    */
    private static void show02() {
        ...
        System.out.println(path1);//D:\idealProjects\basic-code\20-File\123.txt
